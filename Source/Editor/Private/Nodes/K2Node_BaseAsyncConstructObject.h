...
#include "K2Node_BaseAsyncConstructObject.generated.h"
...
UCLASS(Abstract)
class AIEXTENSIONEDITOR_API UK2Node_BaseAsyncConstructObject : public UK2Node_ConstructObjectFromClass
{

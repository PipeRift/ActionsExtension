...
public:
	...
	const FEdGraphPinType& GetType() const
	{
		return Type;
	}
...
protected:
	FBaseActionProperty(FProperty* Property) : Property(Property)
	{
		RefreshProperty();
	}
...
struct FDelegateActionProperty : public FBaseActionProperty
{
	...
	FDelegateActionProperty(FMulticastDelegateProperty* Property = nullptr) : FBaseActionProperty(Property) {}
...
struct FVariableActionProperty : public FBaseActionProperty
{
	...
	FVariableActionProperty(FProperty* Property = nullptr) : FBaseActionProperty(Property) {}
};

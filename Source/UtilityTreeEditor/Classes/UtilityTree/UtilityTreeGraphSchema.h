...
#include "UtilityTreeGraphSchema.generated.h"

class FMenuBuilder;

UCLASS()
class UUtilityTreeGraphSchema : public UEdGraphSchema_K2
{
	...
	//static void SpawnNodeFromAsset(UUtilityTreeAsset* Asset, const FVector2D& GraphPosition, UEdGraph* Graph, UEdGraphPin* PinIfAvailable);
